...
test_sch01_list_sender_rejected() {
  ...
  db_exec "INSERT INTO conversations (id, created_at_ms) VALUES ('cnv_01', 2000);"
...
test_sch04_duplicate_delivery_rejected() {
  ...
  db_exec "INSERT INTO conversations (id, created_at_ms) VALUES ('cnv_04', 2000);"
  db_exec "
    INSERT INTO messages (id, conversation_id, sender_address_id, body, created_at_ms)
...
test_sch06_delivered_event_no_actor() {
  ...
  db_exec "INSERT INTO conversations (id, created_at_ms) VALUES ('cnv_06', 2000);"
  db_exec "
    INSERT INTO messages (id, conversation_id, sender_address_id, body, created_at_ms)
...
test_sch07_state_changed_needs_actor() {
  ...
  # Setup: conversation → message → delivery
  db_exec "INSERT INTO conversations (id, created_at_ms) VALUES ('cnv_07', 2000);"
  db_exec "
    INSERT INTO messages (id, conversation_id, sender_address_id, body, created_at_ms)
